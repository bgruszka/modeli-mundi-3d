...
export class UniverseExplorer {
    constructor() {
        ...
        this.modelInfo = {
            ...
            hubble: {
                title: "Hubble's Expanding Universe (1929)",
                description: "Edwin Hubble's revolutionary discovery that galaxies are moving away from us with velocities proportional to their distance, proving the universe is expanding uniformly in all directions. This observation overthrew Einstein's static universe model and laid the foundation for Big Bang cosmology. Watch as galaxies exhibit redshift effects - more distant galaxies appear redder due to the Doppler effect of their recession. The visualization demonstrates Hubble's Law (v = H₀ × d) with 100 galaxies at various distances, showing how the expansion rate increases with distance. Green arrows indicate expansion directions, distance rings help visualize cosmic scales, and the color gradient from blue to red represents the redshift spectrum. This discovery revolutionized our understanding of cosmic evolution and the universe's age, structure, and ultimate fate."
            }
        };
