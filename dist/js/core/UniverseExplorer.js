    ...
    constructor() {
        ...
        this.modelInfo = {
            ...
            hubble: {
                ...
                description: "Edwin Hubble's revolutionary discovery that galaxies are moving away from us with velocities proportional to their distance, proving the universe is expanding uniformly in all directions. This observation overthrew Einstein's static universe model and laid the foundation for Big Bang cosmology. 🔍 VISUAL GUIDE: Blue galaxies are nearby, red galaxies are distant and receding faster (redshift effect). Green arrows show 'Hubble Flow' - universal expansion directions. Blue-labeled rings mark distance scales (15, 30, 45, 60 megaparsecs). Watch galaxies continuously move apart, grow dimmer, and shift redder as they recede! The white pulsing galaxy at center is our Milky Way observation point. This discovery revealed the universe's age (~13.8 billion years) and led to Big Bang theory."
            }
        };
